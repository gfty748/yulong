            ...
            <div class="stageLeft">
                ...
                <div class="stage-spot">
                    ...
                    <div class="feature-list">
                        <ul>
                            <c:forEach items="${ticktes}" var="ticket">
                                <li>
                                    <a href="javascript:" class="feature-img"><img src="images/img-31.jpg"/></a>
                                    <div class="feature-div">
                                        <h2 class="feature-t"><a href="javascript:">${ticket.t_name}</a></h2>
                                        <span>${ticket.t_description}</span>
                                    </div>
                                    <div class="feature-btn">
                                        <span>￥${ticket.t_price}</span>
                                        <a  href="#" onclick="addCart(${ticket.t_id})" class="feature-r" t_id="${ticket.t_id}">加入<br/>购物车</a>
                                        <a  href="#"  class="feature-l">立即<br/>购买</a>
                                    </div>
                                </li>
                            </c:forEach>
                        </ul>
            ...
            <div class="stageRight">
                ...
                <div class="stage-ico">
                    ...
                    <div class="scenic-ico">
                        <ul>
                            <li><a href="featureSpot.html"><img src="images/feature-01.png"/></a><span><a
                                    href="twoStage/featureSpot.html">玉龙景点</a></span></li>
                            <li><a href="featureSpot.html"><img src="images/feature-021.png"/></a><span><a
                                    href="threeLevel/featureSpot.html">门&nbsp;&nbsp;票</a></span></li>
                            <li><a href="tourismIndex.html"><img src="images/feature-03.png"/></a><span><a
                                    href="threeLevel/tourismIndex.html">景区交通</a></span></li>
                            <li><a href="travelService.html"><img src="images/feature-04.png"/></a><span><a
                                    href="twoStage/travelService.html">客服中心</a></span></li>
                            <li><a href="tourismIndex.html"><img src="images/feature-05.png"/></a><span><a
                                    href="threeLevel/tourismIndex.html">旅游指数</a></span></li>
                            <li><a href="tourismIndex.html"><img src="images/feature-06.png"/></a><span><a
