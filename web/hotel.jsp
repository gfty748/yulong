           ...
           <div class="YL-w1060">
               ...
               <div class="YL-header YL-w-header">
                    ...
                    <div class="header-nav">
                      <ul>
                         <li><a href="threeLevel/featureSpot.html">景点介绍</a></li>
                         <li><a href="travelService.html">旅游服务</a></li>
                         <li><a href="threeLevel/circuit.html">推荐线路</a></li>
                         <li><a href="threeLevel/featureSpot.html">票务预订</a></li>
               ...
               <div class="YL-stage">
                  ...
                  <div class="stageLeft">
                     ...
                     <div class="stage-spot">
                       <div class="spot-title"><span><a href="javascript:">推荐酒店 · ${hotel.hotelName}</a></span></div>
                       <div class="activity-lj"><a href="javascript:"><img src="${hotel.hotelImg}"/></a></div>
                       <div class="travel-text">
                              <span class="travel-title">${hotel.hotelName}欢迎您 </span>
                          ...
                          <div class="activity-page">
                             <div class="activity-list">
                                <ul>
                                   <li><a href="HotelServlet?h_id=${prevHotel.hotelId}">上一篇：${prevHotel.hotelName}</a></li>
                                   <li><a href="HotelServlet?h_id=${nextHotel.hotelId}">下一篇：${nextHotel.hotelName} </a></li>
                                </ul>
                             </div>
                          </div>     
                  ...
                  <div class="stageRight">
                     ...
                     <div class="scenic-ico">
                         <ul>
                            <li><a href="threeLevel/featureSpot.html"><img src="images/feature-01.png"/></a><span><a href="twoStage/featureSpot.html">玉龙景点</a></span></li>
