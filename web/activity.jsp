           ...
           <div class="YL-w1060">
               ...
               <div class="YL-header YL-w-header">
                    ...
                    <div class="header-nav">
                      <ul>
                         ...
                         <li><a href="twoStage/circuit.html">推荐线路</a></li>
                         <li><a href="twoStage/featureSpot.html">票务预订</a></li>
                         <li><a href="twoStage/culturalResources.html">资源文化</a></li>
                      </ul>
                    </div>
                    <!--头部导航 end-->
               ...
               <div class="YL-stage">
                  ...
                  <div class="stageLeft">
                     ...
                     <!--玉龙雪山商务网-二级-景区活动  begin-->
                     <div class="stage-spot">
                       
                       <div class="spot-title"><span><a href="javascript:">景区活动 · 纯洁玉龙&nbsp;&nbsp;&nbsp;&nbsp;浪漫之旅</a></span></div>
                       
                       <div class="activity">

                          <div class="activity-text">
                            <span class="activity-img"><a href="javascript:"><img src="${jqgg.img}"/></a></span>
                            <div class="activity-div">
                               <h1><a href="javascript:" class="activity-title">${jqgg.title}</a></h1>
                               <span>${jqgg.content}</span>
                               <a href="javascript:" class="activity-btn">点击进入</a>
                            </div>
                          </div>
                  ...
                  <div class="stageRight">
                     ...
                     <div class="scenic-ico">
                         <ul>
                            ...
                            <li><a href="twoStage/featureSpot.html"><img src="images/feature-021.png"/></a><span><a href="threeLevel/featureSpot.html">门&nbsp;&nbsp;票</a></span></li>
