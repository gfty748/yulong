                  ...
                  <div class="stageLeft">
                     ...
                     <div class="stage-spot">
                       ...
                       <div class="activity">
                          ...
                          <c:forEach items="${routes}" var="route" begin="0" end="2" step="1">
                              <div class="circuit-text">
                            <span class="activity-img"><a href="RouteServlet?r_id=${route.r_id}"><img src="${route.r_img}" width="460px" height="224px"/></a>
                            <div class="circuit-li">
                                <a href="RouteServlet?r_id=${route.r_id}">${route.r_name}</a>
                            </div>
                            </span>
                                  <div class="activity-div">
                                      <h1></h1> ${route.r_description}
                                      <a href="RouteServlet?r_id=${route.r_id}" class="circuit-btn">点击进入</a>
                                  </div>
                              </div>
                          </c:forEach>
                       ...
                       <!--分页 begin-->
                       <div class="list-page">
                        <a href="javascript:" class="previous">上一页
                            <i class="list-i">
                            <img src="images/ico-20.png"/>
                        </i></a><a href="javascript:">1</a><a href="javascript:" class="select">2</a><a href="javascript:">3</a><a href="javascript:">4</a><a href="javascript:" class="next">下一页<i class="list-a"><img src="images/ico-21.png"/></i></a>共4页到<a href="javascript:">自定义</a>页<a href="javascript:">确定</a>
                       </div>
                       <!--分页 end-->
